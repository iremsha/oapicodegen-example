...
func (app *App) Run() error {
	...
	app.registerRoutes(fiberApp, database)
...
func (app *App) registerRoutes(fiberApp *fiber.App, database *database.Database) {
	...
	fiberApp.Post("/cards", cardHandler.Create)
	fiberApp.Get("/cards", cardHandler.GetList)
	fiberApp.Get("/cards:id", cardHandler.GetByID)

	fiberApp.Post("/banks", bankHandler.Create)
	fiberApp.Get("/banks", bankHandler.GetList)
	fiberApp.Get("/banks:id", bankHandler.GetByID)
}
